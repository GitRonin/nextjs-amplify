export const dynamic = "force-dynamic"; // Для SSR (потрібен Blaze план)
// Закоментуй цей рядок для static export на безкоштовному плані
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white flex flex-col items-center justify-center px-4">
      <section className="max-w-2xl w-full space-y-6">
        ...
        <div className="rounded-2xl border border-orange-700 bg-orange-900/20 p-4 space-y-2">
          <h2 className="font-semibold text-orange-400">
            Про Firebase Hosting + Functions
          </h2>
          <ul className="text-xs text-slate-300 space-y-1 list-disc list-inside">
            <li>SSR через Firebase Functions (Node.js runtime)</li>
            <li>Статичні файли на Firebase CDN</li>
            <li>Автоматичний SSL сертифікат</li>
            <li>Інтеграція з Firebase CLI</li>
            <li>Preview channels для тестування</li>
          </ul>
        </div>
      </section>
    </main>
